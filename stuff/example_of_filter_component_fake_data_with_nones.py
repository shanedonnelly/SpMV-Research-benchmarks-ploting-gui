...
data = {
    ...
    'Birthdate': [
        ...
        datetime.datetime(1990, 2, 1, 12, 0, 0),
        datetime.datetime(1990, 3, 1, 12, 0, 0),
        datetime.datetime(1990, 4, 1, 12, 0, 0),
        datetime.datetime(1990, 5, 1, 12, 0, 0),
        datetime.datetime(1990, 6, 1, 12, 0, 0),
        datetime.datetime(1990, 7, 1, 12, 0, 0),
...
st.text("something before the filter component")

# Use the filter component
filtered_df = filter_dataframe(df, max_unique=5)

st.text("something after the filter component")
